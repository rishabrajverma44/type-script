...
export function addFormState({ formID = null, formTitle }: formStateArg): void {
  if (formID != null) {
...
export function setStateForUpdate(id: String): void {
...
export function getTableData(): Array<formStateArg> {
  return formState.items;
}

export function deleteById(id: String | null): void {
...
export function updateById(id: String, title: String): void {
  if (id !== null && title != "") {
